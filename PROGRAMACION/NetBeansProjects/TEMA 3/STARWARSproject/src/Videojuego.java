...
"@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
        ...
        //intro
        System.out.println(ANSI_PURPLE+"===== STAR WARS CÓDIGOS SECRETOS =====\n"
                + ANSI_PURPLE+"Hace mucho tiempo, en una galaxia muy, muy lejana… La Princesa Leia, Luke\n"
                + ANSI_PURPLE+"Skywalker, Han Solo, Chewbacca, C3PO y R2D2 viajan en una nave imperial robada\n"
                + ANSI_PURPLE+"en una misión secreta para infiltrarse en otra estrella de la muerte que el imperio\n"
                + ANSI_PURPLE+"está construyendo para destruirla. (Presiona Intro para continuar)"+ANSI_RESET);
        ...
        do {
            switch (nivel) {
                ...
                case 1:
                    System.out.println(ANSI_PURPLE+"Los problemas empiezan cuando deben realizar un salto hiperespacial hasta al\n"
                            ...
                            + "¿Qué debe introducir?"+ANSI_RESET);
                    ...
                    System.out.println(ANSI_WHITE+"SUMATORIO = " + sumatorio+ANSI_RESET);
                    ...
                    if (respuesta == sumatorio) {
                        ...
                        System.out.println(ANSI_RED+"Ese no era el código correcto… La misión ha sido un fracaso… :( :( :(\n"
                                + "Todavía no eres un Maestro Jedi de las Matemáticas. ¡Vuelve a intentarlo!"+ANSI_RESET);
                        atomarviento = false;
                    }
                    break;
                //Entramos en el NIVEL 2
                case 2:
                    System.out.println(ANSI_PURPLE+"Gracias a Chewbacca consiguen llegar al sistema correcto y ven a lo lejos la estrella\n"
                    ...
                    System.out.println(ANSI_WHITE+"FACTORIAL = " + factorial+ANSI_RESET);
                    respuesta = lector.nextInt();
                ...
                case 3:
                    System.out.println(ANSI_PURPLE+"Han Solo proporciona el código correcto. Atracan en la estrella de la muerte, se\n"
                            ...
                            + "¿Cual es el nivel correcto?"+ANSI_RESET);
                ...
                case 4:
                    System.out.println(ANSI_PURPLE+"Gracias a la inteligencia de Leia llegan al nivel correcto y encuentran la puerta\n"
                    ...
                    if (primo) {
                        System.out.println(ANSI_WHITE+"Es primo"+ANSI_RESET);
                    } else {
                        System.out.println(ANSI_WHITE+"No es primo"+ANSI_RESET);
                ...
                case 5:
                    System.out.println(ANSI_PURPLE+"Consiguen entrar al reactor. Ya solo queda que Luke Skywalker coloque la bomba,\n"
                            ...
                            + "el factorial de M y el factorial de S. ¿Qué valor debe introducir?"+ANSI_RESET);
                    ...
                    System.out.println(ANSI_WHITE+"SUMA = " + suma+ANSI_RESET);

                    respuesta = lector.nextInt();

                    if (respuesta == suma) {
                        System.out.println(ANSI_PURPLE+"Luke Skywalker introduce el tiempo correcto, activa el temporizador y empiezan a\n"
                                ...
                                + "imperio.\n"
                                + "¡Has salvado la galaxia gracias a la Fuerza Jedi de las matemáticas! Enhorabuena ;D"+ANSI_RESET);
